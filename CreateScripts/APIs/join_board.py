...
# ---------------------------
# DynamoDB setup (optional, only if needed for local testing)
# ---------------------------
TABLE_NAME = "TaskBin"
...
# ---------------------------
def create_api(lambda_name="TaskBin_JoinBoard", api_name=None, account_id=None):
    """
    ...
    try:
        lambda_client.add_permission(
            ...
            SourceArn=f"arn:aws:execute-api:{apigw.meta.region_name}:{account_id}:{api_id}/*/POST/joinBoard"
        )
    ...
    endpoint = f"https://{api_id}.execute-api.{apigw.meta.region_name}.amazonaws.com/dev/joinBoard"
